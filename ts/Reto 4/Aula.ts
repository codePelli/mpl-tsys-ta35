class Aula {
    ...
    constructor(id: number, maxEstudiantes: number, materia: string, profesor: Profesor) {
    ...
    private calcularAprobadosPorGenero(genero: string): number {
