class Cine{
    ...
    asientos: {fila: number; columna: string; ocupado: boolean }[][];
    ...
    private crearAsiento(): {fila: number; columna: string; ocupado: boolean }[][]{

        let asientos: {fila: number; columna: string; ocupado: boolean }[][] = [];
        let filas = 8;
        let columnas = 9;
    ...
    private asientoLibre(): {fila: number; columna: string } | null{
